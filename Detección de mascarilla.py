# Detección de mascarilla de cara en tiempo real
# Creando el modelo de red neuronal convolucional
...
# Probando el modelo en tiempo real
# Utilizamos OpenCV para para detectar el rostro
import cv2
import numpy as np
